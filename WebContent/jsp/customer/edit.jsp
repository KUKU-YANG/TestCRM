...
<BODY>
	<s:actionerror/>
	<s:fielderror/>
	<s:form id="form1" name="form1" namespace="/" action="customer_update" method="post" enctype="multipart/form-data" theme="simple">
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								<td>客户名称：</td>
								<td>
								<s:textfield cssClass="textbox" cssStyle="WIDTH: 180px" maxLength="maxLength=50" name="cust_name" value="%{model.cust_name }"/>
								</td>
								<td>客户级别 ：</td>
								<td>
							...
							<TR>
								...
								<td>固定电话 ：</td>
								<td>
								<s:textfield cssClass="textbox" cssStyle="WIDTH: 180px" maxLength="maxLength=50" name="cust_phone" value="%{model.cust_phone }"/>
								</td>
								<td>移动电话 ：</td>
								<td>
								<s:textfield cssClass="textbox" cssStyle="WIDTH: 180px" maxLength="maxLength=50" name="cust_mobile" value="%{model.cust_mobile }"/>
								</td>
							</TR>
